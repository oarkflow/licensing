...
export interface FeatureDefinition {
    ...
    category: string;
    description: string;
    scopes: ScopeDefinition[] | { [category: string]: ScopeDefinition[] };
}

// Categorized Scopes type for the UI
export type CategorizedScopes = { [category: string]: ScopeDefinition[] };
...
// CLI Feature Scopes (83 scopes) - Categorized
export const cliScopes: CategorizedScopes = {
    "Basic Operations": [
...
// GUI Feature Scopes (37 scopes) - Categorized
export const guiScopes: CategorizedScopes = {
    "CRUD Operations": [
...
// API Feature Scopes (83 scopes) - Categorized
export const apiScopes: CategorizedScopes = {
    "Setup & Configuration": [
    ...
    "Transfer": [
        ...
        { id: "api_s071", name: "Transfer Devices Trust", slug: "transfer_devices_trust", description: "Trust a device", minPlan: "business" },
        { id: "api_s072", name: "Transfer Devices Revoke", slug: "transfer_devices_revoke", description: "Revoke device trust", minPlan: "business" },
        { id: "api_s073", name: "Transfer Device Initiate", slug: "transfer_device_initiate", description: "Initiate device transfer", minPlan: "business" },
        { id: "api_s074", name: "Transfer Device Status", slug: "transfer_device_status", description: "Get device transfer status", minPlan: "business" },
        { id: "api_s075", name: "Transfer Cloud Config", slug: "transfer_cloud_config", description: "Cloud transfer configuration", minPlan: "business" },
        { id: "api_s076", name: "Transfer Cloud Upload", slug: "transfer_cloud_upload", description: "Upload to cloud storage", minPlan: "business" },
        { id: "api_s077", name: "Transfer Cloud Download", slug: "transfer_cloud_download", description: "Download from cloud storage", minPlan: "business" },
        { id: "api_s078", name: "Transfer History List", slug: "transfer_history_list", description: "List transfer history", minPlan: "business" },
        { id: "api_s079", name: "Transfer History Detail", slug: "transfer_history_detail", description: "Get transfer details", minPlan: "business" },
        { id: "api_s080", name: "Transfer Schedules List", slug: "transfer_schedules_list", description: "List transfer schedules", minPlan: "business" },
        { id: "api_s081", name: "Transfer Schedules Create", slug: "transfer_schedules_create", description: "Create transfer schedule", minPlan: "business" },
        { id: "api_s082", name: "Transfer Schedules Update", slug: "transfer_schedules_update", description: "Update transfer schedule", minPlan: "business" },
        { id: "api_s083", name: "Transfer Schedules Delete", slug: "transfer_schedules_delete", description: "Delete transfer schedule", minPlan: "business" },
    ],
};
...
// Helper to count scopes in categorized format
export const countCategorizedScopes = (scopes: CategorizedScopes): number => {
    return Object.values(scopes).reduce((total, arr) => total + arr.length, 0);
};

// Helper to flatten categorized scopes to array
export const flattenScopes = (scopes: CategorizedScopes): ScopeDefinition[] => {
    return Object.values(scopes).flat();
};

export const getScopeSummary = () => {
    const cliCount = countCategorizedScopes(cliScopes);
    const guiCount = countCategorizedScopes(guiScopes);
    const apiCount = countCategorizedScopes(apiScopes);
    return {
        cli: cliCount,
        gui: guiCount,
        api: apiCount,
        total: cliCount + guiCount + apiCount,
    };
};
