	...
	return (
		<div className="space-y-8">
			...
			<div className=" rounded-md border p-4">
				<div className="flex flex-col gap-4 lg:flex-row lg:items-center">
					<div className="relative flex-1">
						...
						<Input
							...
							className="h-11 rounded-md border bg-muted pl-10"
						/>
					</div>
				...
				<div className="mt-4 flex flex-wrap gap-3">
					<Select value={filter} onValueChange={setFilter}>
						<SelectTrigger className="w-[140px] rounded-md border bg-muted">
					...
					>
						<SelectTrigger className="w-[180px] rounded-md border bg-muted">
			...
			{isLoading ? (
				...
				<div className=" flex flex-col items-center justify-center rounded-md border border-dashed bg-muted py-12 text-center">
