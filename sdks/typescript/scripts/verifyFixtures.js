...
import { decryptAesGcm, deriveTransportKey, hexToBuffer, verifySignature, } from "../src/crypto.js";
import { decryptStoredLicense } from "../src/license.js";
...
const activationReq = loadJSON("activation_request.json");
const activationResp = loadJSON("activation_response.json");
const storedLicense = loadJSON("stored_license.json");
const licenseData = loadJSON("license_data.json");
